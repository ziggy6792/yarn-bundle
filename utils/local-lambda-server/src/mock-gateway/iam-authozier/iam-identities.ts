...
export const unauthenticatedUserPoolIdentity: IIamIdentity = {
  ...
  userArn: 'arn:aws:sts::596905900055:assumed-role/cdk-monorepo-backend-stag-cdkmonorepobackendidenti-1485D8JDXH705/CognitoIdentityCredentials',
...
export const lambdaRoleIdentity: IIamIdentity = {
  ...
  cognitoAuthenticationProvider: null,
  userArn: 'arn:aws:sts::596905900055:assumed-role/cdk-monorepo-backend-stag-cdkmonorepobackenduserco-NMHY7FLZF98E/cdk-monorepo-backend-user-confirmed-staging',
